		...
		<div>
			...
			<div id="body">
				<div id="figure">
					...
					<span>Rally Foto Daftar Ulang</span>				</div>
		  <div>
					<a href="" class="about">About</a>
									
					<div>
                    <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DATA PESERTA YANG SUDAH MELAKUKAN DAFTAR ULANG</h2>
...
include "koneksi.php";
   ...
   while ($rec=mysql_fetch_row($hasil))
   {
	echo "<tr>";
		...
		<td>$rec[2]</td>
		<td>$rec[3]</td>
		<td><a href=detaildaftar.php?id=$rec[0] class=style1>CEK DATA</a>	</td>
		</td>";
